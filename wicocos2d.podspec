Pod::Spec.new do |s|
  s.name        =  'wicocos2d'
  s.license     =  'MIT'
  s.version     =  'release-2.1rc0a'
  s.summary     =  'cocos2d for iPhone is a framework for building 2D games, demos, and other graphical/interactive applications. Modified for Walkin'
  ...
  s.author      =  { 'Ricardo Quesada' => 'ricardoquesada@gmail.com', 'Zynga Inc.' => 'https://zynga.com/' , 'Paul Wood' => 'https://paulwoodiii.com'}
  s.source      =  {:git => 'https://github.com/PaulWoodIII/cocos2d-iphone.git', :tag => 'release-2.1rc0a'}
